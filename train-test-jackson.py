...
dataFile = open('data/tutor_list_10k.csv')
...
match = 0
no_match = 0
# set the testing file name
dataFileTest = open('data/jackson_list_3.csv')
dataListTest = dataFileTest.readlines()
dataFileTest.close()

for record in dataListTest:
...
print ("\nSuccess Rate =", (float(match) / float(match + no_match)) * 100, "%")
